...
public class Scale2p {
    ...
    private static int binPackAndScale() {
        ...
        dynamicAverageMaxConsumptionRate = 225 * 0.9;//450.0;//230.0;//450.0;//95.0; //450.0; //240.0;
        ...
        log.info(" The BP up scaler recommended for cg2 {}", consumers.size());
    ...
    private static int binPackAndScaled() {
        ...
        int consumerCount = 0;
        List<Partition> parts = new ArrayList<>(topicpartitions2);
        dynamicAverageMaxConsumptionRate = 225.0*0.7;//450.0;//230.0;//450.0;//95.0; //450.0; //240.0;
